...
import com.mobica.ifootball.services.SensorDataService;
...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    /**
     * A sending-switch preference change listener which starts/stops service
     */
    private static Preference.OnPreferenceChangeListener sendingSwitchPreferenceChangeListener = new Preference.OnPreferenceChangeListener() {
        @Override
        public boolean onPreferenceChange(Preference preference, Object value) {
            if ((boolean) value) {
